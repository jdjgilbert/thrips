...
## Hacked LEGEND function that allows more flexibility with points and lines in a figure legend
...
# ============
                      ...
                      title.adj = 0.5, seg.len = 2)
  {
    ...
    if (plot && (has.pch || do.lines)) {
      pt.COL <- rep(pt.col, length.out=n.leg)
      line.COL <- rep(line.col, length.out=n.leg)
    }
